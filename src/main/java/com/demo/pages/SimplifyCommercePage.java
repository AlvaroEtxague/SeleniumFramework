...
public class SimplifyCommercePage extends BasePageObject<SimplifyCommercePage> implements SimplifyCommerceModel {
    //CONSTRUCTOR
    public SimplifyCommercePage(WebDriver driver) {
        super(driver);
    }
